...
class SequencePredictor(Model):
    ...
    def add_prediction_op(self):
        ...
        initial_state = cell.zero_state(batch_size=tf.shape(x)[0], dtype=tf.float32)
    ...
    def add_loss_op(self, preds):
        ...
        #loss = tf.reduce_mean(tf.losses.mean_squared_error(labels=y,predictions=preds))
